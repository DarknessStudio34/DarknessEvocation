...
<p>Android: extraia o arquivo do projeto (se você não possui um gerenciador de arquivos, recomendo Zarchiver <img src ="assets/readme/za.png" width '25px' heigth="25"> https://play.google.com/store/apps/details?id=ru.zdevs.zarchiver)</p>
